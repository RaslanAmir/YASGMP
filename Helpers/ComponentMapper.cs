    ...
    public static class ComponentMapper
    {
        ...
        public static Component ToComponent(MachineComponent mc)
        {
            ...
            return new Component
            {
                ...
                QrCode           = mc.QrCode ?? string.Empty,
                QrPayload        = mc.QrPayload ?? string.Empty,
                CodeOverride     = mc.CodeOverride ?? string.Empty,
                IsCodeOverrideEnabled = mc.IsCodeOverrideEnabled,
        ...
        public static MachineComponent ToMachineComponent(Component c)
        {
            ...
            return new MachineComponent
            {
                ...
                QrCode           = string.IsNullOrWhiteSpace(c.QrCode) ? null : c.QrCode,
                QrPayload        = string.IsNullOrWhiteSpace(c.QrPayload) ? null : c.QrPayload,
                CodeOverride     = string.IsNullOrWhiteSpace(c.CodeOverride) ? null : c.CodeOverride,
                IsCodeOverrideEnabled = c.IsCodeOverrideEnabled,
