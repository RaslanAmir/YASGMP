                ...
                .ConfigureServices((ctx, services) =>
                {
                    ...
                    services.AddYasGmpCoreServices(core =>
                    {
                        ...
                        svc.AddSingleton<ModuleRegistry>(sp =>
                        {
                            ...
                            registry.Register<DocumentControlModuleViewModel>(DocumentControlModuleViewModel.ModuleKey, "Document Control", "Quality", "Controlled documents and SOP lifecycle");
